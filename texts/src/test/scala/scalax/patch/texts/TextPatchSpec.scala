...
class TextPatchSpec extends AnyFunSuite {
  ...
  test("make") {
    ...
    TextPatch.make("hello, dear friend!", "hello, my friend!") shouldBe TextPatch(Step(3, 3, 12, 10, Equal("lo, "), Delete("dear"), Insert("my"), Equal(" fri")))
    TextPatch.make("hello, dear friend!", "good bye, my friend!") shouldBe TextPatch(Step(0, 0, 15, 16, Delete("hello, dear"), Insert("good bye, my"), Equal(" fri")))
  }
  ...
  test("apply") {
    ...
    TextPatch(Step(3, 3, 12, 10, Equal("lo, "), Delete("dear"), Insert("my"), Equal(" fri"))) apply "hello, dear friend!" shouldBe "hello, my friend!"
    TextPatch(Step(0, 0, 15, 16, Delete("hello, dear"), Insert("good bye, my"), Equal(" fri"))) apply "hello, dear friend!" shouldBe "good bye, my friend!"
  }
}
