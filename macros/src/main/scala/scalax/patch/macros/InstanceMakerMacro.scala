...
class InstanceMakerMacro(val c: blackbox.Context) extends UCommons {
  ...
  def partialImpl3[T: WeakTypeTag, F1: WeakTypeTag, F2: WeakTypeTag, F3: WeakTypeTag](f1: c.Tree, f2: c.Tree, f3: c.Tree): c.Expr[T] = {
    val target = cc(weakTypeOf[T])
    val from1  = cc(weakTypeOf[F1])
    val from2  = cc(weakTypeOf[F2])
  ...
  def partialImpl4[T: WeakTypeTag, F1: WeakTypeTag, F2: WeakTypeTag, F3: WeakTypeTag, F4: WeakTypeTag](f1: c.Tree, f2: c.Tree, f3: c.Tree, f4: c.Tree): c.Expr[T] = {
    val target = cc(weakTypeOf[T])
    val from1  = cc(weakTypeOf[F1])
    val from2  = cc(weakTypeOf[F2])
    val from3  = cc(weakTypeOf[F3])
  ...
  def partialImpl5[T: WeakTypeTag, F1: WeakTypeTag, F2: WeakTypeTag, F3: WeakTypeTag, F4: WeakTypeTag, F5: WeakTypeTag](f1: c.Tree, f2: c.Tree, f3: c.Tree, f4: c.Tree, f5: c.Tree): c.Expr[T] = {
    val target = cc(weakTypeOf[T])
    val from1  = cc(weakTypeOf[F1])
    val from2  = cc(weakTypeOf[F2])
    val from3  = cc(weakTypeOf[F3])
