...
sealed trait LowPriorityPatchMaker {
  ...
  implicit def unorderedPM[F[_], T](implicit coll: UnorderedCollectionAdapter[F, T]): PatchMaker[F[T]] = UnorderedPatchMaker[F, T]()
...
object PatchMaker extends LowPriorityPatchMaker {
  ...
  private[patch] case class UnorderedPatchMaker[F[_], T]()(implicit coll: UnorderedCollectionAdapter[F, T]) extends AbstractPatchMaker[F[T]](UnorderedCollection, {
    case (l, r) =>
      import coll._
  ...
  private[patch] case class IndexedPatchMaker[F[_], T]()(implicit coll: IndexedCollectionAdapter[F, T]) extends AbstractPatchMaker[F[T]](IndexedCollection, {
    case (i, f) =>
      import coll._
  ...
  private[patch] case class KeyedPatchMaker[F[_, _], K, V]()(implicit coll: KeyedCollectionAdapter[F, K, V]) extends AbstractPatchMaker[F[K, V]](KeyedCollection, {
    case (i, f) =>
      import coll._
